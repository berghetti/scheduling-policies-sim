...
class SimConfig:
    ...
    def __init__(self, name=None, num_queues=None, num_threads=None, mapping=[], avg_system_load=None,
                 ...
                 constant_service_time=False, regular_arrivals=False, worker_cores_count=None, ws_sibling_first=True,
                 ...
                 rps=1000000,
                 afp_enable=False, afp_rr=False,
                 afp_starvation_counter_threshold=None,
                 afp_unconditional_interrupt=None):
        # Basic configuration
        self.name = name
        self.description = ""
        ...
        self.worker_cores_count = worker_cores_count
        ...
        self.afp_rr = afp_rr
        self.afp_unconditional_interrupt = afp_unconditional_interrupt
        self.AFP_STARVATION_COUNTER_THRESHOLD = 1000
        self.PREEMPTION_QUANTUM = 5000
        self.PREEMPTION_OVERHEAD = 1000
        self.count_interrupts = 0
        self.afp_starvation_counter = 0
