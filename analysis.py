...
def analyze_sim_run(run_name, output_file, print_results=False, time_dropped=0):
    ...
    queues_file = open(RESULTS_SUBDIR_NAME.format(run_name) + QUEUES_FILE_NAME, "r")
    ...
    percentil_long_requests = np.percentile(task_latencies_long, [99.9, 99.5, 99, 95, 90, 50]) if len(task_latencies_long) > 0 else [0,0,0,0,0,0]
    percentil_short_requests = np.percentile(task_latencies_short, [99.9, 99.5, 99, 95, 90, 50]) if len(task_latencies_short) > 0 else [0,0,0,0,0,0]
    ...
    data_string = "{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}," \
                  ...
                  "{}".format(
        run_name[4:],
        meta_data["num_threads"],
        meta_data["sim_duration"],
        meta_data["PERSEPHONE_OVERHEAD"],
        meta_data["AVERAGE_SERVICE_TIME"],
        meta_data["avg_system_load"],
        avg_load * 100,
        avg_task_load * 100,
        avg_ws_load * 100,
        percentiles[0],
        ...
        percentiles[2],
        percentiles[3],
        slowdown_percentiles[0],
        slowdown_percentiles[1],

        percentil_short_requests[0], #99.9
        percentil_long_requests[0],
        percentil_short_requests[1], #99.5
        percentil_long_requests[1],
        percentil_short_requests[2], #99
        percentil_long_requests[2],
        percentil_short_requests[3], #95
        percentil_long_requests[3],
        percentil_short_requests[4], #90
        percentil_long_requests[4],
        percentil_short_requests[5], #50
        percentil_long_requests[5],

        percent_stolen * 100,
        avg_steals,
        throughput,
        meta_data["rps"],
        orphan_time_percentile,
        real_load * 100,
        (stats["Global Park Count"]/stats["End Time"]) * 10**9,
        successful_ws_time,
        unsuccessful_ws_time,
        non_work_conserving_time,
        allocation_time,
        task_time,
        distracted_time,
        unpaired_time,
        paired_time,
        avg_requeue_wait_time,
        flag_task_time,
        avg_time_from_alloc_to_task,
        avg_flag_steals_per_task,
        flag_steal_rate,
        flag_rate,
        percent_flag_stolen * 100,
        average_steals_per_flag,
        avg_core_flag_wait_time * 100,
        avg_task_flag_wait_time,
        avg_queueing_time,
        avg_core_flag_wait_time_99,
        avg_flag_set_delay_time,
        avg_flag_set_delay_time_99,
